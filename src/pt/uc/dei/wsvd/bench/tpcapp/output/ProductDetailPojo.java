 ...
 */
@XmlType(name = "ProductDetailPojo", namespace = "http://tpcapp.bench.wsvd.dei.uc.pt/")
public class ProductDetailPojo {
    ...
    @XmlElement(namespace = "http://tpcapp.bench.wsvd.dei.uc.pt/", type = String.class)
    ...
    @XmlElement(namespace = "http://tpcapp.bench.wsvd.dei.uc.pt/", type = Date.class)
    ...
    @XmlElement(namespace = "http://tpcapp.bench.wsvd.dei.uc.pt/", type = Byte.class)
