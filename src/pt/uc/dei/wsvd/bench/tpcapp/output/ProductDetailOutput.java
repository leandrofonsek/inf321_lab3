 ...
 */
@XmlType(name = "ProductDetailOutput", namespace = "http://tpcapp.bench.wsvd.dei.uc.pt/")
public class ProductDetailOutput {
    ...
    @XmlElement(namespace = "http://tpcapp.bench.wsvd.dei.uc.pt/", type = ProductDetailPojo.class)
