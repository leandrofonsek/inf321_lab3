...
import pt.uc.dei.wsvd.bench.tpcc.object.Order;
import pt.uc.dei.wsvd.bench.tpcc.object.OrderLine;
...
public class OrderStatus_VxA {
    ...
    private static final Logger logger = Logger.getLogger(OrderStatus_VxA.class.getName());
...
//            printMessage("An error occurred!");
            logger.log(Level.SEVERE," ORDER STATUS  EXCEPTION " + e.toString());
        } finally {
