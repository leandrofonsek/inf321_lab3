 ...
 */
@XmlType(name = "DeliveryResult", namespace = "http://tpcc.bench.wsvd.dei.uc.pt/")
public class DeliveryResult implements Serializable {
     ...
     */
    @XmlElement(namespace = "http://tpcc.bench.wsvd.dei.uc.pt/", type = Integer.class)
     ...
     */
    @XmlElement(namespace = "http://tpcc.bench.wsvd.dei.uc.pt/", type = DistrictDelivery.class)
