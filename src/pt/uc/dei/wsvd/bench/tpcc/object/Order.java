 ...
 */
@XmlType(name = "Order", namespace = "http://tpcc.bench.wsvd.dei.uc.pt/")
public class Order implements Serializable {
     ...
     * @return the o_id
     */
    @XmlElement(namespace = "http://tpcc.bench.wsvd.dei.uc.pt/", type = Long.class)
    public long getO_id() {
        return o_id;
    }
     ...
     * @return the c_id
     */
    @XmlElement(namespace = "http://tpcc.bench.wsvd.dei.uc.pt/", type = String.class)
     ...
     * @return the entdate
     */
    @XmlElement(namespace = "http://tpcc.bench.wsvd.dei.uc.pt/", type = Date.class)
     ...
     */
    @XmlElement(namespace = "http://tpcc.bench.wsvd.dei.uc.pt/", type = OrderLine.class)
